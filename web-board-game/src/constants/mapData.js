const INITIAL_MAP = [
    // 0~6: 상단 변 (7칸)
    // 출발지 14, 찬스 4 18, 세계여행 7, 국세청 9, 사회복지 0, 무인도 21
    ...
    // 21~27: 좌측 변 (7칸)
    { name: "세계여행", price: 0, type: "special" }, // 7 (모서리)
    { name: "제주도", price: 300, type: "land", owner: null, ownerName: null, buildingLevel: 0 },
    { name: "국세청", price: 150, type: "special" }, // 9 (세금 징수)
    ...
    // 14~20: 하단 변 (7칸)
    { name: "출발지", price: 0, type: "start" }, // 14
    ...
    { name: "찬스", price: 0, type: "special" }, // 18 (찬스)
    ...
    // 7~13: 우측 변 (7칸)
    { name: "무인도", price: 0, type: "special" }, // 21 (모서리)
